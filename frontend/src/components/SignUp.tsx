  ...
  return (
    <div className="p-5 w-full mb-5">
      <form className="max-w-sm mx-auto" onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          type="submit"
          className="text-white w-full mt-3 bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
        >
          Register
        </button>
      </form>
